...
<body>
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <form class="manage-profile" action="{{route('technician.updateProfile')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="right-content">
                    <div class="tab-navigation">
                        <li class="tab" data-tab="shop-details">Shop Details<img src="{{asset('images/Account-details.png')}}"></li>
                        <li class="tab" data-tab="specialization-services">Specialization and Services<img src="{{asset('images/service.png')}}"></li>
                        <li class="tab active" data-tab="opening-hours">Opening Hours<img src="{{asset('images/schedule.png')}}"></li>
                        <li class="tab" data-tab="certificates">Certificates<img src="{{asset('images/certificate.png')}}"></li>
                    </div>

                    <div id="shop-details" class="tab-content">
                    ...
                    <div id="specialization-services" class="tab-content active">
                        <h3>Main Mastery</h3>
                        <div class="form-section">
                            <div class="form-group">
                                @php
